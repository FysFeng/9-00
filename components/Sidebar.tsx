  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-white text-slate-800 flex flex-col z-50 border-r border-slate-200 shadow-sm">
      ...
      <div className="px-3 py-6 space-y-1 border-b border-slate-100">
        ...
        <NavItem to="/tracker" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 14l2 2 4-4M7 4h10a2 2 0 012 2v12a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2zm2 4h6" /></svg>} label="竞品优惠追踪" />
      </div>
